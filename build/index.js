  ...
  `},docsPage:function(){const e={start:{title:"Get started",content:P`
    ...
    `},styles:{title:"# Styles",content:P`
      ...
      <p>
        ...
        <button class="link" @click=${()=>ne.to("/docs-config")}>
