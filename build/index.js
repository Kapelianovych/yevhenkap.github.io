"use strict";var e="home-module_home-content__3iyjs",t="home-module_logo__1Bv_I",n="home-module_description__LzC3X",o="home-module_get-started-btn__2SC4O";function a(e){console.warn(e)}void 0===window.trustedTypes&&(window.trustedTypes={createPolicy:(e,t)=>t});const s=window.trustedTypes.createPolicy("edelweiss",{createHTML:e=>e});let i="/public/styles/";function r(e){return null==e}class c{constructor(e){this._value=e}static just(e){return new c(e)}static nothing(){return new c(null)}static maybeOf(e){const t=g(e)?e.extract():e;return r(t)?c.nothing():c.just(t)}isJust(){return!this.isNothing()}isNothing(){return r(this._value)}map(e){return this.isJust()?c.maybeOf(e(this._value)):c.nothing()}apply(e){return e.isJust()?this.map(e.extract()):c.nothing()}chain(e){return this.isJust()?e(this._value):c.nothing()}extract(){return this._value}}const{just:l,nothing:d,maybeOf:u}=c;function g(e){return e instanceof c}function h(...e){return Object.freeze(e)}function m(...e){return Object.freeze(e.map(e=>Array.from(e)).reduce((e,t)=>e.concat(t),[]))}function p(e){return e instanceof Error?Promise.reject(e):Promise.resolve(e)}class b{constructor(e){this._value=e}static wrap(e){const t=function(e){return e instanceof b}(e)?e.extract():e;return new b(t)}map(e){return b.wrap(e(this._value))}apply(e){return this.map(e.extract())}chain(e){return e(this._value)}extract(){return this._value}}const{wrap:f}=b;function C(e){u(e).map(e=>e.remove())}function E(e,...t){u(e).map(e=>e.append(...t))}function v(e,...t){u(e).map(e=>e.replaceWith(...t))}function y(e,t,n){u(e).map(e=>e.setAttribute(t,n))}function w(e,t){return u(e).map(e=>e.getAttribute(t))}function _(e,t){return Boolean(u(e).map(e=>e.hasAttribute(t)).extract())}function x(e,t=document){return u(t).map(t=>t.querySelector(e))}function N(e,t){_(e,t)&&u(e).map(e=>e.removeAttribute(t))}function k(e,t,n,o={}){const a=u(e).map(e=>(e.addEventListener(t,n,o.add),e)).map(e=>()=>function(e,t,n,o){u(e).map(e=>e.removeEventListener(t,n,o))}(e,t,n,o.remove));return g(e)?a:a.extract()}function M(e){return`${class{static get cssRootFolder(){return i}static set cssRootFolder(e){i=e}}.cssRootFolder}${e}${/.+\.css$/.test(e)?"":".css"}`}function $(e){!function(...e){return(...t)=>{let n=d();for(const o of e){if(n.isJust()&&!Object.is(n.extract(),NaN))return n;n=u(o(...t))}return n}}(()=>x(`link[href="${M(e)}"]`,document.head).extract(),()=>(E(document.head,f(document.createElement("link",void 0)).map(e=>(y(e,"rel","stylesheet"),e)).map(t=>(y(t,"href",M(e)),t)).extract()),null))()}function D(e){x(`link[href="${M(e)}"]`,document.head).map(C)}class O{styles(){return""}beforeBuild(){}template(){return""}afterBuild(){}async _createNodes(){const e=this.styles();e.length>0&&(Array.isArray(e)?e.forEach($):$(e)),await p(this.beforeBuild());const t=await p(this.template());return await p(this.afterBuild()),t}}function S(){return""+window.crypto.getRandomValues(new Uint32Array(1))[0]}const R=/@([\w-]+)=['"]?$/,A=/^eventId[\d]{1,}$/,I=/\?([\w-]+)=['"]?$/,F=/:(mounted|updated|removed)=$/,T=/:.+:(\?)?/g,L=new Map;var B;!function(e){e.Mounted="mounted",e.Updated="updated",e.Removed="removed"}(B||(B={}));const z=function e(t,n=!1){return n&&Object.getOwnPropertyNames(t).forEach(n=>{const o=t[n];"object"!=typeof o&&"function"!=typeof o||e(o)}),Object.freeze(t)}({[B.Mounted]:new Map,[B.Updated]:new Map,[B.Removed]:new Map});async function P(e,...t){return e.reduce((e,n,o)=>u(t[o]).map(p).map(e=>e.then(e=>j(e))).map(e=>e.then(e=>Array.isArray(e)?Promise.all(e.map(e=>j(e))).then(e=>e.join("")):e)).map(t=>e.then(e=>function(e,t,n){return e.then(e=>{const o=R.exec(t);if(!r(o)){let s=e;"function"!=typeof s&&r(s.handleEvent)&&(a(`Event listener must be type of "function" or object with\n  "handleEvent" method, but given "${typeof s}".`),s=()=>{});const i=S();return L.set(i,{[o[1]]:s}),t.replace(o[0],`data-event-id${n}="${i}"`)}const s=I.exec(t);if(!r(s))return t.replace(s[0],e?s[1]:"");const i=F.exec(t);if(!r(i)){const n=S(),o=i[1];return z[o].set(n,e),t.replace(F,`data-${o}-hook-id="${n}"`)}return t+e})}(t,n,o).then(t=>e+t))).extract()||e.then(e=>e+n),p(""))}function j(e){return e instanceof O?e._createNodes():e}const U=new Set,H=new Set;function q(e){return e.nodeType===Node.ELEMENT_NODE}function G(e){return e.nodeType===Node.TEXT_NODE}function K(e){return e.nodeType===Node.COMMENT_NODE}function W(e){Y(e,B.Mounted),m(e.childNodes).forEach(W)}function J(e){Y(e,B.Updated)}function Z(e){Y(e,B.Removed),m(e.childNodes).forEach(Z)}function Y(e,t){setTimeout(()=>{q(e)&&w(e,`data-${t}-hook-id`).map(e=>h(e,u(z[t].get(e)))).map(([n,o])=>o.map(o=>p(o(e)).then(()=>z[t].delete(n))))},0)}const X=[];function Q(e){e instanceof HTMLElement&&(Object.entries(e.dataset).filter(([e,t])=>A.test(e)).map(([t,n])=>(u(n).map(e=>L.get(e)).map(Object.entries).map(([t])=>X.push(k(e,t[0],t[1]))),t)).map(e=>u(/(\d+)$/.exec(e)).map(e=>e[1])).forEach(t=>t.map(t=>N(e,"data-event-id"+t))),e.childElementCount>0&&m(e.children).forEach(Q))}function V(e,t){return x(e).map(e=>h(e,function(e,t=!1){return g(e)?e.map(e=>e.cloneNode(t)):e.cloneNode(t)}(e))).map(([e,n])=>async function e(t){return Array.isArray(t)?t.reduce((t,n)=>t.then(t=>e(n).then(e=>t+e)),p("")):t instanceof O?t._createNodes():t}(t).then(e=>{n.innerHTML=s.createHTML(e)}).then(()=>{U.forEach($),H.forEach(D),U.clear(),H.clear()}).then(()=>function e(t,n){if(q(t)&&q(n))if(t.tagName===n.tagName)if(function(e,t){let n=!1;return e.attributes.length!==t.attributes.length&&m(e.attributes).forEach(({name:o})=>{_(t,o)||(N(e,o),n=!0)}),m(t.attributes).forEach(({name:t,value:o})=>{w(e,t).extract()!==o&&(y(e,t,o),n=!0)}),n}(t,n)&&J(t),n.hasChildNodes()){const o=m(t.childNodes),a=m(n.childNodes);for(let n=0;n<Math.max(a.length,o.length);n++){const s=o[n],i=a[n];r(i)?r(s)||(C(s),Z(s)):r(s)?(E(t,i),W(i)):e(s,i)}}else t.hasChildNodes()&&(v(t,n),W(n),Z(t));else v(t,n),W(n),Z(t);else G(t)&&G(n)?t.textContent!==n.textContent&&(t.textContent=n.textContent,u(t.parentElement).map(J)):K(t)&&K(n)?t.textContent!==n.textContent&&(t.textContent=n.textContent):(v(t,n),W(n),Z(t))}(e,n)).then(()=>X.forEach(e=>e())).then(()=>X.length=0).then(()=>m(e.children).forEach(Q)).then(()=>L.clear())).extract()||p(void 0)}const ee=new Map;let te={path:"",container:"",view:()=>""};const ne={basePrefix:"",baseContainer:""};class oe{static get current(){return te}static configure(e){const{basePrefix:t,baseContainer:n}=e;r(t)||(ne.basePrefix=t),r(n)||(ne.baseContainer=n)}static add(e){Array.isArray(e)?e.forEach(e=>ee.set(e.path,e)):ee.set(e.path,e)}static to(e,t={}){const n=ae(e);if(0===ee.size)return a(`You cannot navigate to ${n} because you didn't define any routes!\n      At first call "Router.add(...)".`),p(void 0);let o;return m(ee.entries()).forEach(([e,a])=>{const s=function(e,t){let n=t.startsWith("^")?t:"^"+t;return n=n.endsWith("$")?n:n+"$",u(e.match(n.replace(T,"(.+)$1")))}(n,ae(e));if(s.isJust()){const e=a.container||ne.baseContainer;o=s.chain(o=>x(e).map(async()=>{te=Object.assign(Object.assign({},a),{parameters:o}),r(a.before)||await p(a.before()),await V(e,a.view()),(r(t.willStateChange)||t.willStateChange)&&window.history.pushState({path:n,container:e},"",n),r(a.after)||await p(a.after())})).extract()}}),r(o)?(a(`No route is specified for path: ${n}!`),p(void 0)):o}static async reload(){const{container:e,view:t,after:n,before:o}=te;r(o)||await p(o()),await V(e||ne.baseContainer,t()),r(n)||await p(n())}static back(){window.history.back()}static forward(){window.history.forward()}}function ae(e){return e.startsWith(ne.basePrefix)?e:ne.basePrefix+e}k(window,"popstate",e=>{r(e.state)||oe.to(e.state.path,{willStateChange:!1})});var se="docs-module_doc-page__dI202",ie="docs-module_doc-content__2b9d5",re="docs-module_opened__JHHx0";const ce=function(e){return new Proxy(e,{set(e,t,n,o){const a=Reflect.set(e,t,n,o);return a&&oe.reload(),a},deleteProperty(e,t){if(t in e){const n=Reflect.deleteProperty(e,t);return n&&oe.reload(),n}return!1}})}({isSidebarOpened:!1,activeButtonId:"start"});var le=Object.freeze({UI:ce}),de="icon-module_icon__1lqVa",ue={home:"data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22iso-8859-1%22%3F%3E%3Csvg%20version%3D%221.1%22%20id%3D%22Layer_1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%20x%3D%220px%22%20y%3D%220px%22%20%20viewBox%3D%220%200%20512%20512%22%20style%3D%22enable-background%3Anew%200%200%20512%20512%3B%22%20xml%3Aspace%3D%22preserve%22%3E%3Cg%3E%20%3Cg%3E%20%20%3Cpath%20d%3D%22M506.555%2C208.064L263.859%2C30.367c-4.68-3.426-11.038-3.426-15.716%2C0L5.445%2C208.064%20%20%20c-5.928%2C4.341-7.216%2C12.665-2.875%2C18.593s12.666%2C7.214%2C18.593%2C2.875L256%2C57.588l234.837%2C171.943c2.368%2C1.735%2C
%3E%3C%2Fg%3E%3Cg%3E%3C%2Fg%3E%3Cg%3E%3C%2Fg%3E%3Cg%3E%3C%2Fg%3E%3Cg%3E%3C%2Fg%3E%3Cg%3E%3C%2Fg%3E%3Cg%3E%3C%2Fg%3E%3Cg%3E%3C%2Fg%3E%3Cg%3E%3C%2Fg%3E%3Cg%3E%3C%2Fg%3E%3Cg%3E%3C%2Fg%3E%3Cg%3E%3C%2Fg%3E%3Cg%3E%3C%2Fg%3E%3Cg%3E%3C%2Fg%3E%3Cg%3E%3C%2Fg%3E%3Cg%3E%3C%2Fg%3E%3C%2Fsvg%3E"};function ge(e,t="Icon"){return P`
  ...
  `},docsPage:function(){const e={start:{title:"Get started",content:P`
      ...
      <p>
        ...
        <button
          class="link"
          @click=${()=>oe.to("/docs-cli").then(()=>le.UI.activeButtonId="cli")}
        >
    ...
    `},html:{title:"# HTML",content:P`
      ...
      <code
        >
        ${he("const paragraph: Promise<string> = html`<p>Hello world!</p>`;")}
        </code
      >
      ...
      <code>
        ${he("function handleClick(event: MouseEvent) {\n          =: console.log('Clicked!');\n          }\n          const button: Promise<string> = html`\n          =: <button @click=${handleClick}>Click me</button>\n          `;\n          ")}
      </code>
      ...
      <code>
        ${he("// Hook signature, you can provide more concise type by yourself.\n           type HookCallback = (self: Element) => void | Promise<void>;\n          ")}
      </code>
      ...
      <p>
        First parameter is <strong>tagName</strong> - this is name of the tag of custom element.
      </p>

      <blockquote>
        ${ge("lightbulb")} Name of the tag of custom element must be in
      ...
      <p>
        Second parameter is <strong>template</strong> - this is function that accepts
        object of custom element (DOM node) and must return inner HTML of custom element
        as <b>string</b> or <b>${he("Promise<string>")}</b>.
      </p>

      <p>
        Optional third parameter is custom element settings: <i>object</i> with <strong>hooks</strong>,
        <strong>observedAttributes</strong> and <strong>extends</strong> properties
        or tuple with <i>class</i> that describes custom element behavior and optional
        <i>tagName</i> (last one is needed if you creates customized built-in element).
      </p>

      <p>
        By default <em>defineWebComponent</em> function creates autonomous custom
        element with <strong>HTMLElement</strong> prototype and register created
        custom element.
      </p>

      <blockquote>
        ${ge("lightbulb")} <a href="https://developer.mozilla.org/en-US/docs/Web/Web_Components/Using_custom_elements">Detailed about custom elements
        here.</a>
      </blockquote>

      <code>
        ${he("defineWebComponent(\n           =: 'my-component',\n           =: // HTML will be added to Shadow root of custom element.\n           =: (element: HTMLElement) => {\n           =: =:  return html`\n           =: =: =:   <p>Hello</p>\n           =: =: =:   <slot></slot>\n           =: =: `\n           =: },\n           =: // If you want customize behavior of custom element,\n           =: // provide third parameter.\n          )\n          ")}
      </code>

      <p>
        Then you may use custom element as regular ones.
      </p>
    ...
    `},component:{title:"# Component",content:P`
      ...
      <code>${he("template(): string | Promise<string>")}</code>

      <p>Also you <i>can</i> override</p>

      <code>${he("beforeBuild(): void | Promise<void>")}</code>

      <p>
        method that invokes before <b>template</b> method and
      </p>

      <code>${he("afterBuild(): void | Promise<void>")}</code>
      ...
      <blockquote>
        ${ge("lightbulb")} Note that <b>beforeBuild</b> and
      ...
      <code>
        ${he("class MyComponent extends Component {\n            =: async beforeBuild() {\n            =: =:   // Some useful work\n            =:  }\n          \n            =:  async template() {\n            =: =: return html`<p>Hello</p>`;\n            =:  }\n          \n            =:  async afterBuild() {\n            =: =:  // Some useful work\n            =:  }\n          }\n          ")}
      </code>
    ...
    `},router:{title:"# Router",content:P`
      ...
      <blockquote>
        ${ge("lightbulb")} Does not set changes to state in route hooks. This
      ...
      <ol>
        <li>
          <code class="inline-block">
            ${he("configure(options: Partial<RouterOptions>): void")}
          </code>
          ...
          <ol>
            <li>
              ...
              <blockquote>
                ${ge("lightbulb")} It may be needed in case, when all routes
        ...
        <li>
          <code class="inline-block">
            ${he("to(path: string, options?: { willStateChange?: boolean }): Promise<void>")}
          </code>
        ...
        <li>
          <code class="inline-block">
            ${he("reload(): Promise<void>")}
          </code>
          - Reloads current page.
        </li>
        <li>
          <code class="inline-block">${he("back(): void")}</code> -
          return to previous page.
        </li>
        <li>
          <code class="inline-block">${he("forward(): void")}</code> -
          forwards to next page if it is in history.
        </li>
        <li>
          <code class="inline-block">
            ${he("add(routes: Route | Route[]): void")}
          </code>
      ...
      <code class="typescript">
        ${he('// Example: path === "/root/asdf"\n          Router.current.parameters; // Will be ["/root/asdf", "asdf"]')}
      </code>

      <blockquote>
        ${ge("lightbulb")} Actually <strong>parameters</strong> is result of
    ...
    `},state:{title:"# State",content:P`
      ...
      <blockquote>
        ${ge("lightbulb")} Object that is returned by
    ...
    `},styles:{title:"# Styles",content:P`
      ...
      <code>
        ${he("registerCss(name: string | Array<string>): (immediately?: boolean) => void")}
      </code>
      <p>
        ...
        <button
          class="link"
          @click=${()=>oe.to("/docs-config").then(()=>le.UI.activeButtonId="config")}
        >
      ...
      <code>
        ${he("registerCss('header'); // Note that you may not provide extension\n            // or\n            registerCss('main.css');\n          ")}
      </code>

      <blockquote>
        ${ge("lightbulb")} This function is not load stylesheet immediately,
        but register is to be loaded on next rendering step (any of the page
        that you defined).
      </blockquote>

      <blockquote>
        ${ge("lightbulb")} If you use
    ...
    `},i18n:{title:"# I18n",content:P`
      ...
      <ol>
        <li>
          <code class="inline-block">
            ${he("setLanguage(tag: string): Promise<void>")}
          </code>
        ...
        <li>
          <p>
            <code class="inline-block">
              ${he("translate(path: string, variables?: { [string]: string }): string")}
            </code>
          ...
          <code class="typescript">
            ${he("I18n.translate('home.menu.about');")}
          </code>
          ...
          <code>
            ${he("I18n.translate('greeting', { name: 'Peter' }); // Output will be \"Hello, Peter!\"")}
          </code>
          ...
          <blockquote>
            ${ge("lightbulb")} The <em>translate</em> function is also
        ...
        <li>
          <code class="inline-block">
            ${he("add(languages: I18nLanguagesSet, initial?: string): void")}
          </code>
          <p>
      ...
      <ol>
        <li>
          <code class="typescript inline-block">
            ${he("languagesTags: Array<string>")}
          </code>
          - returns all tags for languages, that you set to I18n.add method.
        </li>
        <li>
          <code class="typescript inline-block">
            ${he("currentLanguage: string | undefined")}
          </code>
      ...
      <code class="typescript">
        ${he("I18n.languagesTags; // returns ['uk', 'en']\n           I18n.currentLanguage; // 'uk'\n           ")}
      </code>
    `},config:{title:"# Config",content:P`
      ...
      <ol>
        <li>
          <code class="typescript inline-block">
            ${he("static get cssRootFolder(): string")}
          </code>
        ...
        <li>
          <code class="typescript inline-block">
            ${he("static set cssRootFolder(dir: string): void")}
          </code>
          - change css root folder.
        </li>
      </ol>
    `},cli:{title:"# CLI",content:P`
      <blockquote>
        ${ge("lightbulb")} For using CLI you must have NodeJS version >=
      ...
      <code class="bash">
        ${he("$ npm i -g @prostory/edelweiss-cli")}
      </code>

      <p>or</p>

      <code class="bash">
        ${he("$ yarn global add @prostory/edelweiss-cli")}
      </code>
      ...
      <ul>
        <li>
          ...
          <code class="bash">
            ${he("# Init project in app directory\n            $ es app")}
          </code>

          <code class="bash">
            ${he("# Init project in current directory\n            $ es .\n            # or\n            $ es")}
          </code>
        </li>
        ...
        <li>
          ...
          <blockquote>
            ${ge("lightbulb")} Another templates are in progress.
          </blockquote>
        ...
        <li>
          ...
          <blockquote>
            ${ge("lightbulb")} If other arguments except
    ...
    `}},[,t="start"]=oe.current.parameters||[];return P`<div class=${se}>
    ${P`
    <nav
      :mounted=${()=>{le.UI.activeButtonId=oe.current.parameters&&oe.current.parameters[1]||"start"}}
      class="${me}"
    >
      <button
        @click=${e=>{oe.to("/docs").then(()=>{fe("start")})}}
        class="${pe}  ${Ce("start")}"
      >
        Get started
      </button>
      <button
        @click=${e=>{oe.to("/docs-html").then(()=>{fe("html")})}}
        class="${pe}  ${Ce("html")}"
      >
        HTML
      </button>
      <button
        @click=${e=>{oe.to("/docs-component").then(()=>{fe("component")})}}
        class="${pe}  ${Ce("component")}"
      >
        Component
      </button>
      <button
        @click=${e=>{oe.to("/docs-router").then(()=>{fe("router")})}}
        class="${pe}  ${Ce("router")}"
      >
        Router
      </button>
      <button
        @click=${e=>{oe.to("/docs-state").then(()=>{fe("state")})}}
        class="${pe}  ${Ce("state")}"
      >
        State
      </button>
      <button
        @click=${e=>{oe.to("/docs-styles").then(()=>{fe("styles")})}}
        class="${pe}  ${Ce("styles")}"
      >
        Styles
      </button>
      <button
        @click=${e=>{oe.to("/docs-i18n").then(()=>{fe("i18n")})}}
        class="${pe}  ${Ce("i18n")}"
      >
        I18n
      </button>
      <button
        @click=${e=>{oe.to("/docs-config").then(()=>{fe("config")})}}
        class="${pe}  ${Ce("config")}"
      >
        Config
      </button>
      <hr />
      <button
        @click=${e=>{oe.to("/docs-cli").then(()=>{fe("cli")})}}
        class="${pe} ${Ce("cli")}"
      >
        CLI
      </button>
  ...
  `}
    <div
      class="${ie} ${le.UI.isSidebarOpened?re:""}"
    >
      <section>
        <h2>${e[t].title}</h2>
  ...
  </div>`}},ve="header-module_header__L1ZnK",ye="header-module_col__kbp4m",we="header-module_menu__ZYk9A",_e="header-module_docs-btn__27TvJ";var xe="footer-module_footer__3zCYC";function Ne(e){return P`
    ${P`
    <header class="${ve}">
      <div class=${ye}>
        ${oe.current.path.includes("/docs")?P`
              <button
                aria-label="Toggle menu button"
                @click=${()=>{le.UI.isSidebarOpened=!le.UI.isSidebarOpened}}
                class="${we}"
              >
                <span></span>
                <span></span>
              ...
              <button aria-label="Home button" @click=${()=>oe.to("/")}>
                ${ge("home","Home icon")}
              </button>
            `:""}
      </div>
      <div class="${ye}">
        <button
          class="${_e}"
          @click=${()=>oe.to("/docs").then(()=>le.UI.activeButtonId="start")}
        >
          Docs
        </button>
        <button
